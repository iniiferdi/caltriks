...
export function ExplainSub({ entry }) {
        ...
        <div className="mt-4 bg-[#121212] border p-3 rounded-2xl border-[#1E1E20] text-sm text-gray-200">
            <div className="space-y-3">
                ...
                <p className="opacity-65">
                    Pengurangan matriks dilakukan dengan mengurangkan elemen-elemen yang bersesuaian dari dua matriks yang memiliki ukuran sama.
                </p>
                ...
                <div>
                    ...
                    >
                        ...
                        <span className="text-sm">Langkah Pengurangan</span>
                    </button>
                                            ...
                                            {row.map((_, j) => {
                                                ...
                                                return (
                                                    <div key={j} className="flex items-center gap-1">
                                                        ...
                                                        <span className="font-semibold">{diff.toFraction(true)}</span>
                                                    </div>
                                                );
                                            })}
                                        </div>
